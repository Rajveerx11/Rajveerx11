...
Python, TypeScript, React, Kotlin, Flask, Git, MongoDB, Firebase

**Capable — I've shipped real work using these:**
Rust, PyTorch, TensorFlow, scikit-learn, OpenCV, AWS, MySQL, Tailwind CSS

**Exploring — Currently going deeper here:**
Agentic AI systems, MCP integrations, ML theory, systems-level Rust
